    ...
    return (
        <div className='app__header app__wrapper section__padding' id="home">
            <div className='app__wrapper_info'>
                ...
                <p className='header_text'>Make your home repairs simpler and stress-free.<br></br> Our experienced professionals offer a full range of services to help you upgrade, maintain, or restore your home without hassle.</p>
